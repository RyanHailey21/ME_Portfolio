...
role: 'Co-founder and Drivetrain Lead'
startDate: '2024-08'
endDate: '2026-08'
ownership:
  - Drivetrain subsystem design intent
  - Drivetrain sub-team coordination and scheduling
  - Mentorship of junior members
  - Chassis structural simulation
resumeHighlights:
  - Co-founded UTA's inaugural RoboMasters team and led drivetrain design and cross-team integration.
  - Designed and manufactured custom drivetrain components using CAD and additive manufacturing.
  - Performed modal, stiffness, and strength simulations in ANSYS Workbench on the aluminum chassis.
---
